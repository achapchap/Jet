...
!     +++++++++++++++++++++++++++++++++++++++++++++++++++++
      ...
      subroutine ridis6(k,ng,proat,kget,ygb,zgb,ynsl,znsl,ycnsl,zcnsl,phinsl,&
...
! now finish up and work it up to the body origin
 ...
 99     write(*,*) 'PUPUPU, kk and kmed', kk, kmed ! in case kk ==1 or 0 and kmed == 0  we end up here.
...
! - aggiungo getto a yn zn, se ng>0 e kget = 0
      ...
      do i=2,ng+1
          ...
          zn(nn+nn1+i) = zgb(i)
          tn(nn+nn1+i) = tgb(i)
          print*, 'jet panels', jt,nn+nn1+i,tgb(i), ygb(i),zgb(i) 
          write(27,'(2i4,3d15.7)') jt,nn+nn1+i,tgb(i), ygb(i),zgb(i)
        enddo
      endif 
